...
//    lateinit var lights: RevBlinkinLedDriver
    ...
    override fun init(ahwMap: HardwareMap) {
        ...
        leftTransferUpperSensor = hwMap["leftUpSensor"] as NormalizedColorSensor
        leftTransferUpperSensorWrapped = WrappedColorSensor(1, leftTransferUpperSensor)
        rightTransferUpperSensor = hwMap["rightUpSensor"] as NormalizedColorSensor
...
//        neopixelDriver.init_neopixels()
    ...
    open fun getActualState(drivetrain: Drivetrain, collectorSystem: CollectorSystem, depoManager: DepoManager, previousActualWorld: ActualWorld?): ActualRobot = measured("getActualState"){
