...
//        opencv.onNewFrame(teamPropDetector::processFrame)
        ...
        when (propPosition) {
            PropPosition.Left -> {
                ...
                movement.driveRobotStrafe(power = 0.5, inches = 22.5, smartAccel = true)
...
//                //Collect
//                moveRotator(ThreeDayHardware.RotatorPos.Rest.position)
//                movement.driveRobotPosition(power = normalMovementSpeed, inches = 10.0, smartAccel = true)
//                movement.driveRobotStrafe(power = 0.5, inches = -15.0, smartAccel = true)
//                movement.driveRobotPosition(power = normalMovementSpeed, inches = 20.0, smartAccel = true)
//                movement.driveRobotStrafe(power = 0.5, inches = -20.0, smartAccel = true)
//                movement.driveRobotStrafe(power = 0.5, inches = 3.0, smartAccel = true)
//                movement.driveRobotPosition(power = normalMovementSpeed, inches = 30.0, smartAccel = true)
//                movement.driveRobotStrafe(power = 0.5, inches = 20.0, smartAccel = true)
            }
            PropPosition.Center -> {
